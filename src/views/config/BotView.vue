<template>
    ...
    >
        ...
        <div
            class="bg-white shadow-2xl rounded-3xl p-12 max-w-4xl w-full mx-6 text-center border border-gray-100"
        >
            <!-- Title -->
            <h1 class="text-4xl font-black text-gray-900 mb-4 tracking-tight">Discord Setup</h1>
